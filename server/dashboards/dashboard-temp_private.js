return {
	id: "bot_analytics_dashboard_TEMP",
	name: "Bot Analytics Dashboard",
	icon: "code",
	url: "bot_analytics_dashboard_TEMP",
	description: "Microsoft Bot Framework based analytics",
	preview: "/images/bot-framework-preview.png",
	config: {
		connections: {
			"application-insights": {
				apiKey: "oxpy4xodzshj4dke7rdiwlqx0xrsntq2vip7y538",
				appId: "a9c98f0f-594e-44e3-81fd-d5b9fc621447"
			}
		},
		layout: {
			isDraggable: true,
	...
	elements: [{
			...
			dependencies: {
				visible: "modes:users",
				values: "ai:timeline-users-channelUsage"
			},
			props: {
				showLegend: false,
				compact: true
	...
	dialogs: [{
      ...
      // TOOD:Issue75 
            ...
            customEvents
              ...
              | extend activitytype=customDimensions.activitytype
              | where activitytype == 'contactRelationUpdate'
            */
            // TODO:implement calcualted method @ln662
            // TODO:implement mapping (so app does not fail at null or unexpected vals)
						query: () => ` exceptions` +
            ` | summarize error_count=count() by type, innermostMessage` +
            ` | project type, innermostMessage, error_count` +
            ` | order by error_count desc `
			...
			elements: [{
					...
					props: {
						cols: [{
								...
								header: "Day X to ... Y", // iterate based on special field
								field: "handledAt"
							},{
								type: "button",
								value: "more",
