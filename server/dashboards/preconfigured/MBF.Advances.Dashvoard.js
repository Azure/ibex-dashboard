return {
	...
	description: "Microsoft Bot Framework Advanced Analytics Dashboard",
	...
	elements: [{
			...
			dependencies: {
				visible: "modes:messages",
				values: "nfl:timeline-channelUsage"
			},
			props: {
				showLegend: false,
				compact: true
			...
			dependencies: {
				visible: "modes:users",
				values: "nfl:timeline-users-channelUsage"
			},
			props: {
				showLegend: false,
				compact: true
			...
			actions: {
				onBarClick: {
					...
					params: {
						title: "args:intentName",
						intent: "args:intentName",
						queryspan: "timespan:queryTimespan"
					}
				}
			}
	...
	dialogs: [{
			...
			elements: [{
					...
					dependencies: {
						values: "intentsDialog-data:entities-usage",
						bars: "intentsDialog-data:entities-usage-bars"
					},
					props: {
						nameKey: "entityType"
					}
					...
					dependencies: {
						values: "intentsDialog-data:sample-response-types",
						bars: "intentsDialog-data:sample-response-types-bars"
					},
					props: {
						nameKey: "name"
					}
			...
			elements: [{
					...
					dependencies: {
						values: "conversations-data:conversations"
					},
					props: {
						hideBorders: true,
						cols: [{
