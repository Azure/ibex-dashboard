...
class Dialog extends React.PureComponent {
    ...
    render() {
        ...
        ].map((primaryText, i) => (<ListItem_1.default key={i} onClick={this.closeDialog} primaryText={primaryText}/>));
        return (<Dialogs_1.default id={id} visible={visible} title="Simple Title" onHide={this.closeDialog}>
        <List_1.default>
          {items}
        </List_1.default>
      </Dialogs_1.default>);
