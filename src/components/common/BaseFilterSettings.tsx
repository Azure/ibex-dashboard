 ...
 */
export abstract class BaseFilterSettings<T extends IBaseSettingsState> 
      ...
      <Card>
        ...
        <div className="md-grid">
          ...
          <span className="md-cell md-cell--bottom  md-cell--6">
            <div className="md-grid">
              <span className="md-cell--3 md-cell--middle"><FontIcon>offline_pin</FontIcon></span>
