...
var Scatter = (function (_super) {
    ...
    Scatter.prototype.render = function () {
        ...
        return (React.createElement(Card_1.Card, { className: 'dash-card' },
            React.createElement(Card_1.CardHeader, { className: 'card-header', title: 'Scatter', subtitle: "Scatter chart bla bla" }),
            React.createElement(Card_1.CardMedia, { style: styles_1.default.cards.cardMediaStyle },
                React.createElement(recharts_1.ResponsiveContainer, null,
                    React.createElement(recharts_1.ScatterChart, { margin: { top: 5, right: 30, left: 20, bottom: 5 } },
                        React.createElement(recharts_1.XAxis, { dataKey: 'x', tickFormatter: format, minTickGap: 20, name: 'stature' }),
                        React.createElement(recharts_1.YAxis, { dataKey: 'y', name: 'weight', unit: 'kg' }),
                        React.createElement(recharts_1.ZAxis, { dataKey: 'z', range: [60, 600], name: 'score', unit: 'km' }),
                        ...
                        React.createElement(recharts_1.Scatter, { name: 'A school', data: data01, fill: '#8884d8' }),
                        React.createElement(recharts_1.Scatter, { name: 'B school', data: data02, fill: '#82ca9d' }))))));
    };
    return Scatter;
